...
\begin{itemize}
    ...
    \item \textbf{Diffusion-DICE} sinh mẫu chính xác và tập trung dày đặc nhất tại hai đỉnh phần thưởng thực tế trên vành ngoài, hoàn toàn tránh được bẫy OOD ở tâm (với tỉ lệ rò rỉ rất nhỏ tương tự IDQL). Cơ chế IGL học trọng số in-sample $w^*(a)$ từ chính dữ liệu trong $\mathcal{D}$, bảo đảm guidance không bao giờ kéo policy ra ngoài support dữ liệu.
\end{itemize}
...
bảo hiệu năng và tính an toàn của policy.
