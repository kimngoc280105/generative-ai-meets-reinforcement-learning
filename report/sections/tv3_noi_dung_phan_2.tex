...
goal-reaching được giải quyết bằng cách tối đa hóa xác suất đến trạng
thái mục tiêu $g$:
...
\paragraph{Từ Goal-reaching đến RL Tổng quát}
...
\paragraph{Liên hệ với RLZero và Zero-shot RL}
...
training thêm. Với cross-embodiment transfer từ 10 video YouTube, RLZero
...
\textbf{Empowerment} \cite{eysenbach2025generativerl} là một framework để
...
\begin{figure}[H]
    ...
    \caption{Empowerment được đo bằng mutual information giữa hành động
    và trạng thái tương lai. Vị trí ngã tư có empowerment cao (nhiều
    phương án tác động đến tương lai) so với ngõ cụt (empowerment thấp).
    Nguồn: \cite{eysenbach2025generativerl}.}
...
\cite{eysenbach2025generativerl} kết hợp skill learning với successor
...
rõ ràng hơn và có thể được tái sử dụng trực tiếp trong zero-shot RL
...
\begin{figure}[H]
    ...
    (chạy, nhảy, cân bằng) bằng cách tối đa hóa mutual information giữa
