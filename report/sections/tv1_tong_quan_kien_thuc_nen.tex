...
\textbf{Chính sách} $\pi$ là chiến lược ra quyết định của tác nhân, hay một
...
\textbf{Mục tiêu Học Tăng cường} là tìm chính sách $\pi$ tối đa hóa lợi tức kỳ vọng, tức phần thưởng tích lũy kỳ vọng trên tất cả các quỹ đạo có thể
xảy ra:
...
\textit{hàm khả năng của trạng thái tương lai},tức thước đo kế tiếp, kết hợp với cấu trúc Bellman để tận dụng dữ liệu ngoài chính sách. Đây
...
\begin{table}[H]
    ...
    \begin{tabular}{p{0.32\textwidth} p{0.32\textwidth} p{0.32\textwidth}}
        ...
        \textbf{Ý nghĩa chung} \\
        \midrule
        Chính sách $\pi(a \mid s)$ & Mô hình tạo sinh $p(x)$ & Phân phối cần học \\
        ...
        Gradient chính sách & Ước lượng hàm điểm số & Cách tối ưu phân phối \\
