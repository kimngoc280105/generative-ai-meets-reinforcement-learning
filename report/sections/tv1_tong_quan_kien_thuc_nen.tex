...
\textbf{Mục tiêu Học Tăng cường} là tìm policy $\pi$ tối đa hóa lợi tức kỳ vọng, tức phần thưởng tích lũy kỳ vọng trên tất cả các trajectory có thể
xảy ra:
...
Hàm Q xuất hiện xuyên suốt tutorial: trong diffusion policy
...
quan sát trong các trajectory có lợi tức cao. Đây là ví dụ điển hình
...
\begin{table}[H]
    ...
    \begin{tabular}{p{0.32\textwidth} p{0.32\textwidth} p{0.32\textwidth}}
        ...
        Hàm Q $Q(s,a)$ & Tỉ lệ hàm khả năng $\frac{p^\pi(s_f|s,a)}{p(s_f)}$ & Ước lượng xác suất tương lai \\
